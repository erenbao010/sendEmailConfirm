...
import com.sendEmailSpringBoot.demo.appUser.AppUserRepository;
import com.sendEmailSpringBoot.demo.appUser.AppUserRole;
import com.sendEmailSpringBoot.demo.appUser.AppUserService;
import com.sendEmailSpringBoot.demo.appUser.AppUser;
import com.sendEmailSpringBoot.demo.email.EmailSender;
...
//            token = appUserService.singUpUser(new AppUser(request.getFirstName(), request.getLastName(), request.getEmail(), request.getPassword(), AppUserRole.ADMIN));
//        } else {
//            token = appUserService.singUpUser(new AppUser(request.getFirstName(), request.getLastName(), request.getEmail(), request.getPassword(), AppUserRole.USER));
//        }
//        String link = "http://localhost:8080/api/v1/registration/confirm?token=" + token;
    ...
    public String verifyToken (String token) {
        ...
        if (verificationToken.getConfirmedAt() != null) {
            throw  new IllegalStateException("email confirmed");
        }
